...
\item ``R'' marked on a card means ``Produce the following \goodss\ each round during the \myPhase{Production \& Maintain Workers} phase''.
...
In addition, the player should take the \goodss\ indicated by any Trade Route spaces occupied by their workers. Note that Trade Route spaces do not affect the production section of the Player Status Board.
