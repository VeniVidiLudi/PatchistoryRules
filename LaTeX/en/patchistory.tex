...
\iftoggle{original-rules}{
\date{v1.3d 2014-11-11}
}{
\date{v1.3.1sk 2014-11-18}
}
\begin{document}
...
\item[Sacagewa:] Your \pol\ is increase by 1 for each Hero in your Territory. In addition, during the production step, gain 1 Food for every 2 Heroes in your Territory (round down).
\end{description}}
\section*{Credits}
\newcommand\noda{Kim~Jun~Hyup}
