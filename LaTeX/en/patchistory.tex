...
\item The winning player (if any) takes victory points: \eraCost{5}{10}{15} VPs for a winning Invader; \eraCost{3}{6}{9} VPs for a winning Defender.
...
\item[Statue of Liberty:] Ignore the territory size limit when patching cards. In addition, gain 3 VPs per wasteland created using the \myAction{Reclaimation} action in your territory at the end of the game.
